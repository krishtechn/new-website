<footer class="text-gray-600 body-font">
            ...
            <div class="bg-gray-100">
              <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                ...
                <p class="text-gray-500 text-sm text-center sm:text-left">©copyright copy Technical krish 2021 —   
                  <a href="https://www.youtube.com/channel/UCF5oO43y67XYOfJRiPif1rw/videos" class="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer">Technical krish</a>
                </p>
